...
struct AppSocialLink: Identifiable {
    ...
    static let all: [AppSocialLink] = [
        AppSocialLink(
            id: "youtube",
            title: "YouTube",
            url: URL(string: "https://www.youtube.com/@TufanCakirOfficial")!
        ),
        AppSocialLink(
            id: "instagram",
            title: "Instagram",
        ...
        AppSocialLink(
            id: "x",
            title: "X",
            url: URL(string: "https://x.com/tufan_cakir_?s=11")!
        ),
        AppSocialLink(
            id: "facebook",
            title: "Facebook",
        ...
        AppSocialLink(
            id: "github",
            title: "GitHub",
            url: URL(string: "https://github.com/TufanCakir")!
        ),
        AppSocialLink(
            id: "discord",
            title: "Discord",
            url: URL(string: "https://discord.gg/z9qpMgdAj")!
        ),
        AppSocialLink(
            id: "linkedin",
            title: "LinkedIn",
