    ...
    private static func summonNews() -> [NewsItem] {
        ...
        return root.banners.map { banner in
            NewsItem(
                ...
                title: banner.title,
                body:
                    "Summon Banner mit \(banner.pool.count) Drakons im Pool und \(banner.currency.uppercased()) als Waehrung.",
                category: "summon",
        ...
        EggConfigLoader.load().eggs.map { egg in
            NewsItem(
                ...
                body: egg.description
                    ?? "Dieses Ei kann einen Baby Drakon ausbrueten.",
                category: "egg",
                icon: egg.eggImage,
    ...
    private static func skinNews() -> [NewsItem] {
        SkinConfigLoader.load().skins.map { skin in
            NewsItem(
                ...
                title: skin.title,
                body: skin.description ?? "Neuer Drakon Skin verfuegbar.",
                category: "skin",
                icon: skin.image,
